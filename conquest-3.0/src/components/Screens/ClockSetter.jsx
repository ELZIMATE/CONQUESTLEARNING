...
const ClockSetter = ({workTime, setWorkTime, socialTime, setSocialTime, leisureTime, setLeisureTime, fitnessTime, setFitnessTime, isRunning, running, category, setCategory, user, entry, ...feats}) => {
